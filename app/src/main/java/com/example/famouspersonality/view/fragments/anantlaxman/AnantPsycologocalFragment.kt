...
class AnantPsycologocalFragment : Fragment() {

    private lateinit var binding: FragmentAnantPsycologocalBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAnantPsycologocalBinding.inflate(layoutInflater)
