...
class AnantSymbolOfYouthFragment : Fragment() {

    private lateinit var binding: FragmentAnantSymbolOfYouthBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentAnantSymbolOfYouthBinding.inflate(layoutInflater)
